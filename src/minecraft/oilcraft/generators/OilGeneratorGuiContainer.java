...
public class OilGeneratorGuiContainer extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2,
		...
		this.mc.renderEngine.bindTexture(Oilcraft.GUI_DIRECTORY
				+ "OilGenerator.png");
		int x = (width - xSize) / 2;
		...
		/*
		 * top of tank is 4 px down and bottom is 72 px down giving a height of
		 * 68
		 */
		int emptyPixels = (int) (68 * (1 - 0.25));
		// this.drawTexturedModalRect(x + 5, y + 4, 177, 1, 26, 3 + fillPixels);
		this.drawTexturedModalRect(x + 5, y + 8 + emptyPixels, 177,
				4 + emptyPixels, 26, 68 - emptyPixels);
	}
